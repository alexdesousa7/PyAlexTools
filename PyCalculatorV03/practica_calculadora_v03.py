...
Button(miFrame, text="CE", command=borrar_entrada, **estilo_boton).grid(row=1, column=0)
Button(miFrame, text="C", command=borrar_todo, **estilo_boton).grid(row=1, column=1)
